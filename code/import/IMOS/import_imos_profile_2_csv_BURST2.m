...
thefile = '../../../data-lake/imos/amnmprofile/IMOS_-_Australian_National_Mooring_Network_(ANMN)_Facility_-_WQM_and_CTD_burst_averaged_data_products_2019_2022.csv';
...
[~,headers] = xlsread(thefile,'A1:CA1');

[snum,sstr] = xlsread(thefile,'A2:CA689555');
    ...
    for j = 1:length(ustations)
        ...
        if foundvar > 0
            ...
            if ~isempty(thedata)
                ...
                filename = [outpath,sitekey.imosbgc.(thesiteval{foundstation}).AED,'_','BURST2_',filevar,'_DATA.csv'];

function ALICE2NewSpecies()
    ...
    main_file = [datapath,'data-lake/UWA/AED/swan-phytoplankton/20110728_Swan River Master Data_ all data P1 to P3-1.xlsx'];
    outdir = [datapath,'data-warehouse/csv/uwa/aed/phy/Species/2/'];
    ...
    VarListStruct = agency.UWA_AED_PHY_2_Species;
        ...
        for varIndex = [14,10,15,17,18] %this is the array of indexes of the variables I want in the variable "DataTables"
            ...
            [fDATA,fHEADER] = filenamecreator(outdir,SiteStruct,VarStruct);
                ...
                fid = fopen(fHEADER,'w');
                    ...
                    fprintf(fid,'Contact Email,%s\n','Lachy Gill <00114282@uwa.edu.au> 17/09/2024');

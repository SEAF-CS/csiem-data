function CSV_HoldingPlanktonGroup()
    ...
    VarListStruct = agency.DWER_PhytoplanktonGroups;
    ...
    for SiteNum = 1:length(filecell)
        ...
        for row = 1:height(T)
            % I modified the data because one of the GroupName col was empty but species name was Raphidophyta, (Which is a group name too) So i just copied it over

...
FDIAT_IN = FDIAT * 16/100;
FDIAT_IP = FDIAT * 16/100;
FDIAT_RHO = FDIAT * 16/100;

MDIAT_IN = MDIAT * 16/100;
MDIAT_IP = MDIAT * 16/100;
MDIAT_RHO = MDIAT * 16/100;

KARLO_IN = KARLO * 16/100;
KARLO_IP = KARLO * 16/100;
KARLO_RHO = KARLO * 16/100;

DINO_IN = DINO * 16/100;
DINO_IP = DINO * 16/100;
DINO_RHO = DINO * 16/100;

DIATOM_IN = DIATOM * 16/100;
DIATOM_IP = DIATOM * 16/100;
DIATOM_RHO = DIATOM * 16/100;

CRYPT_IN = CRYPT * 16/100;
CRYPT_IP = CRYPT * 16/100;
CRYPT_RHO = CRYPT * 16/100;

CHLA_IN = CHLA * 16/100;
CHLA_IP = CHLA * 16/100;
CHLA_RHO = CHLA * 16/100;

function import_phytoplankton_Group_Staged()
    ...
    main_dir = [datapath,'data-warehouse/csv_holding/wcwa/ploom/phy/group/30/'];
    outdir = [datapath,'data-warehouse/csv/wcwa/ploom/phy/group/30/'];
    ...
    VarListStruct = agency.WCWA30_PhytoplanktonGroup;

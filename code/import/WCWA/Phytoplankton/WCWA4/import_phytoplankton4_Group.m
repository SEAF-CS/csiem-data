function import_phytoplankton4_Group()

    run('../../../../actions/csiem_data_paths.m')

    main_dir = [datapath,'data-lake/WCWA/Phyto/WCWA3/'];
    outdir = [datapath,'data-warehouse2/csv/wcwa/PhytoPlankton4/Groups/'];
    ...
    VarListStruct = agency.WCWA4_PhytoplanktonGroup;
            ...
            for rowNum = 1:height(T)
                ...
                if ~exist(fDATA,'file')
                    ...
                    fid = fopen(fHEADER,'w');
                        ...
                        fprintf(fid,'Tag,WCWA4_Phytoplankton_Group\n');

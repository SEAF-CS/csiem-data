function import_phytoplankton4_Species()

    run('../../../../actions/csiem_data_paths.m')

    main_dir = [datapath,'data-lake/WCWA/Phyto/WCWA3/'];
    outdir = [datapath,'data-warehouse2/csv/wcwa/PhytoPlankton4/Species/'];
    ...
    VarListStruct = agency.WCWA4_PhytoplanktonSpecies;
    ...
    for fileNum = 1:length(filecell)
        ...
        for SiteNum = 1:NumofSites
            ...
            DateStr = '1998-12-23 00:00:00'; %'December 23 1998'
            ...
            for rowNum = 1:height(T)
                ...
                if ~exist(fDATA,'file')
                    ...
                    fid = fopen(fHEADER,'w');
                        ...
                        fprintf(fid,'Agency Code,WCWA4\n');
                        fprintf(fid,'Program,WCWA4 Phytoplankton\n');
                        fprintf(fid,'Project,WCWA4 Phytoplankton\n');
                        fprintf(fid,'Tag,WCWA4_Phytoplankton_Species\n');

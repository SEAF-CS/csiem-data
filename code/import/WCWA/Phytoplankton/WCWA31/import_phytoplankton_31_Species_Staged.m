function import_phytoplankton_Species_Staged()
    ...
    main_dir = [datapath,'data-warehouse/csv_holding/wcwa/ploom/phy/species/31/'];
    outdir = [datapath,'data-warehouse/csv/wcwa/ploom/phy/species/31/'];
    ...
    VarListStruct = agency.WCWA31_PhytoplanktonSpecies;
    ...
    for filenum = 1:length(filecell)
        ...
        VerticalRef = 'Water Column';
                    ...
                    fid = fopen(header,'w');
                        ...
                        fprintf(fid,'Contact Email,%s\n','Lachy Gill <00114282@uwa.edu.au> 20/02/2025');

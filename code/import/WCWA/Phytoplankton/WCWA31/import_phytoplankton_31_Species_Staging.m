function import_phytoplankton_Species_Staging()
    ...
    main_dir = [datapath,'data-lake/WCWA/PLOOM/Phyto/31/January2000.xls'];
    
    outdir = [datapath,'data-warehouse/csv_holding/wcwa/ploom/phy/species/31/'];
    inputfile = main_dir;

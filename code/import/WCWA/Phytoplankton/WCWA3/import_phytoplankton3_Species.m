function import_phytoplankton3_Species()

    run('../../../../actions/csiem_data_paths.m')

    main_dir = [datapath,'data-lake/WCWA/Phyto/WCWA3/'];
    outdir = [datapath,'data-warehouse2/csv/wcwa/PhytoPlankton3/Species/'];
    ...
    VarListStruct = agency.WCWA3_PhytoplanktonSpecies;
    ...
    for fileNum = 1:length(filecell)
        ...
        for SiteNum = 1:NumofSites
            ...
            DateStr = '1999-10-23 00:00:00'; %'October 23 1999'
            ...
            for rowNum = 1:height(T)
                ...
                if ~exist(fDATA,'file')
                    ...
                    fid = fopen(fHEADER,'w');
                        ...
                        fprintf(fid,'Agency Code,WCWA3\n');
                        fprintf(fid,'Program,WCWA3 Phytoplankton\n');
                        fprintf(fid,'Project,WCWA3 Phytoplankton\n');
                        fprintf(fid,'Tag,WCWA3_Phytoplankton_Species\n');

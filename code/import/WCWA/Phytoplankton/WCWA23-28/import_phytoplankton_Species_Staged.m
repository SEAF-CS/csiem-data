function import_phytoplankton_Species_Staged()

    run('../../../../actions/csiem_data_paths.m')
    
    main_dir = [datapath,'data-warehouse/csv_holding/wcwa/ploom/phy/species/23-28/'];
    outdir = [datapath,'data-warehouse/csv/wcwa/ploom/phy/species/23-28/'];
    ...
    VarListStruct = agency.WCWA23_PhytoplanktonSpecies;
    ...
    for filenum = 1:length(filecell)
        ...
        if StructVarIndex == 0
            fprintf("Processing Species,skipping %s\n",filevarheader);
            continue
        end
        ...
        VerticalRef = 'Water Column';
                    ...
                    fid = fopen(header,'w');
                        ...
                        fprintf(fid,'Contact Email,%s\n','Lachy Gill <00114282@uwa.edu.au> 11/02/2025');

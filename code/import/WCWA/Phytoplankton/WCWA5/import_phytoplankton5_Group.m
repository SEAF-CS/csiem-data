function import_phytoplankton5_Group()

    run('../../../../actions/csiem_data_paths.m')

    main_dir = [datapath,'data-lake/WCWA/Phyto/WCWA3/'];
    outdir = [datapath,'data-warehouse2/csv/wcwa/PhytoPlankton5/Groups/'];
    ...
    VarListStruct = agency.WCWA5_PhytoplanktonGroup;
    ...
    for fileNum = 1:length(filecell)
        ...
        for SiteNum = 1:NumofSites
            ...
            DateStr = '1999-1-20 00:00:00'; %'January 20 1999'
            ...
            for rowNum = 1:height(T)
                ...
                if ~exist(fDATA,'file')
                    ...
                    fid = fopen(fHEADER,'w');
                        ...
                        fprintf(fid,'Tag,WCWA5_Phytoplankton_Group\n');

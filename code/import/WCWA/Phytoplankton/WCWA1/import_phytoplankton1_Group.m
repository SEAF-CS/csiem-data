function import_phytoplankton1_Group()

    run('../../../../actions/csiem_data_paths.m')

    main_dir = [datapath,'data-lake/WCWA/PLOOM/Phyto/1/'];
    outdir = [datapath,'data-warehouse/csv/wcwa/ploom/phy/group/1/'];
    ...
    VarListStruct = agency.WCWA1_PhytoplanktonGroup;
    ...
    for SiteNum = 1:length(filecell)
        ...
        for row = 1:height(T)
            ...
            DataVal = T{row,5}*AgencyStruct.Conv; % "Abundance"
            ...
            if ~exist(fDATA,'file')
                ...
                fid = fopen(fHEADER,'w');
                    ...
                    fprintf(fid,'Contact Email,%s\n','Lachy Gill <00114282@uwa.edu.au> 12/08/2024');

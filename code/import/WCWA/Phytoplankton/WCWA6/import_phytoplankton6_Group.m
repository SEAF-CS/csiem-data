function import_phytoplankton6_Group()

    run('../../../../actions/csiem_data_paths.m')

    main_dir = [datapath,'data-lake/WCWA/Phyto/WCWA3/'];
    outdir = [datapath,'data-warehouse2/csv/wcwa/PhytoPlankton6/Groups/'];
    ...
    VarListStruct = agency.WCWA6_PhytoplanktonGroup;
            ...
            for rowNum = 1:height(T)
                ...
                if ~exist(fDATA,'file')
                    ...
                    fid = fopen(fHEADER,'w');
                        ...
                        fprintf(fid,'Tag,WCWA6_Phytoplankton_Group\n');

function create_html_for_directory(outputdirectory,varname,htmloutput)
...
%for i = 3:length(dirlist)
    mdir = dir([outputdirectory,'*.png']);
    
    filename = [htmloutput,varname];
    ...
    for j = 1:length(mdir)
        ...
        plot1 = Image([outputdirectory,mdir(j).name]);

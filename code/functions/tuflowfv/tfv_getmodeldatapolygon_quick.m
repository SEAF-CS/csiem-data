function [data,c_units,isConv] = tfv_getmodeldatapolygon_quick(rawData,filename,X,Y,sX,sY,varname,D,depth_range,layerface,NL,surface_offset,use_matfiles,rawGeo,tdate)
